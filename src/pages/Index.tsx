...
export default function Index() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-purple-900 to-indigo-900">
      {/* Header */}
      <header className="bg-purple-900/80 backdrop-blur-sm shadow-lg py-4 border-b border-purple-700">
      ...
      {/* Hero section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-purple-800/90 to-indigo-900/90 py-20 sm:py-32">
        <div 
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-6 text-lg md:text-xl leading-8 text-purple-100">
      ...
      {/* Features section */}
      <div className="py-16 sm:py-24 bg-gradient-to-b from-indigo-900 to-purple-800">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-lg shadow-lg transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-purple-800 to-indigo-900 border border-haikyu-orange/20 hover:border-haikyu-orange/50">
              ...
              <h3 className="text-xl font-semibold text-white">For Administrators</h3>
      ...
      {/* CTA section */}
      <div className="bg-gradient-to-r from-haikyu-orange/80 to-orange-500/80 py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold tracking-tight text-white">
            ...
            <div className="mt-10 flex justify-center">
              <Button 
                className="bg-white text-purple-800 hover:bg-gray-100 text-lg shadow-lg"
                onClick={() => navigate("/login")}
              >
                Login Now
              </Button>
      ...
      {/* Footer */}
      <footer className="bg-purple-900 py-8 border-t border-purple-800">
        <div className="container mx-auto px-4">
