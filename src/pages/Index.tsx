...
export default function Index() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-800 to-slate-900">
      {/* Header */}
      <header className="bg-slate-900/80 backdrop-blur-sm shadow-lg py-4 border-b border-slate-700">
      ...
      {/* Hero section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-haikyu-navy/90 to-haikyu-black/90 py-20 sm:py-32">
        <div 
      ...
      {/* Features section */}
      <div className="py-16 sm:py-24 bg-gradient-to-b from-slate-900 to-slate-800">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-lg shadow-lg transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-slate-800 to-slate-900 border border-haikyu-orange/20 hover:border-haikyu-orange/50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mt-10 flex justify-center">
              <Button 
                className="bg-white text-haikyu-navy hover:bg-gray-100 text-lg shadow-lg"
                onClick={() => navigate("/login")}
              >
                Login Now
              </Button>
